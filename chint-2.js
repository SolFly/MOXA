...
const registerStart = 3201; // Start address of the register
const registerCount = 2; // Number of registers to read
...
function readData(slaveId) {
  client.readInputRegisters(registerStart, registerCount)
    .then((data) => {
